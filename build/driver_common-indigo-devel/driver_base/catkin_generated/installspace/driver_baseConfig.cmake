...
if("FALSE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/amanda/catkin_ws/src/driver_common-indigo-devel/driver_base)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amanda/catkin_ws/install/${idir}'.  ${_report}")
    endif()
