...
if("FALSE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/amanda/catkin_ws/src/driver_common-indigo-devel/timestamp_tools)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amanda/catkin_ws/install/${idir}'.  ${_report}")
    endif()
